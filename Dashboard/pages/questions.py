...
from sample_analysis.burnout import get_burnout_analysis
...
if burnout_df.empty:
    ...
    # If burnout_score > 1, set the color to red, otherwise blue.
    #avg_burnout_score=burnout_df['burnout_score'].mean()
    ...
    # Scatter plot for overtime vs weekend frequency (unchanged)
    fig2 = px.scatter(burnout_df,
                      x='avg_daily_overtime',
                      y='weekend_frequency',
                      size='avg_monthly_excess',
                      color='burnout_score',
                      hover_name='name',
